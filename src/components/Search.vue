	                  	...
	                  	<div class="theme-popover">														
							...
							<div class="search-content">
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									<li v-for="(c,index) in commodity" @click="trunIntro(c.gid)">
										
										<div class="i-pic limit">
											<img src="@/../static/images/imgsearch1.jpg" />											
											<p class="title fl">{{c.gname}}</p>
											<p class="price fl">
												<b>¥</b>
...
<script>
	export default {
 	 ...
 	 methods:{
				search:function(){
					this.$http.get("http://127.0.0.1:8081/introduction/fun05", {
	params: {
		gname: this.gname
	}
	...
	function(ret) {
		this.commodity = ret.body;
		console.log(ret.body);
	}
)
},
trunIntro: function(gid) {
